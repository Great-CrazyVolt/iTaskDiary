...
const SignUp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const err = await registerUser(authentication)
        checkError(err)
    }
    ...
    return (
        ...
        <Link to="/signIn" className='hidden' ref={linkRef}> Enter </Link>
            ...
            <form onSubmit={handleSubmit}>
                <div className=" px-5 my-5 sm:mx-auto mt-10 max-w-prose">
                    <div className="border border-solid border-gray-300 shadow-lg  rounded-md">
                        <div className="grid grid-cols-6 gap-6 m-6 sm:p-5">
                            ...
                            <div className='col-start-2 col-end-6'>
                                <p className='p-2 rounded text-center bg-red-600 bg-red-600 uppercase text-white font-medium  
                                    leading-tight'> Sign Up </p>
                            </div>
                            ...
                            <div className='col-start-3 col-span-2 flex justify-center '>
                                <button type="submit" className="px-6 py-2.5 bg-red-600 text-white font-medium text-xs 
                                    leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg 
                                    focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 
                                    active:shadow-lg transition duration-150 ease-in-out"> Register </button>
                            </div>
                        </div>
                    </div>
                </div>
